...
> Responses API 仅支持qwen3-max、qwen3-max-2026-01-23、qwen3.5-plus和qwen3.5-plus-2026-02-15。
...
-   **千问Plus**：qwen3.5-plus、qwen3.5-plus-2026-02-15及之后的快照版本
...
-   `turbo` （默认）: 兼顾响应速度与搜索效果，适用于大多数场景。
    ...
    > 自2026年2月27日起，启用该策略时额外收费，参见[计费说明](#92ce83df3a599)。
...
-   `agent`：可多次调用联网搜索工具与大模型，实现多轮信息检索与内容整合。
    ...
    > 该策略仅适用于 qwen3.5-plus、qwen3.5-plus-2026-02-15、qwen3-max、qwen3-max-2026-01-23、qwen3-max-2025-09-23。
...
> 仅支持中国内地地域，思考模式下的 qwen3-max、qwen3-max-2026-01-23，以及qwen3.5-plus、qwen3.5-plus-2026-02-15。
...
-   **搜索策略费用**：
    ...
    -   **turbo 与 max 策略**：
        ...
        -   2026年2月27日 00:00 之前：限时免费。
            
        -   2026年2月27日 00:00 起：正式计费。每调用 1000 次的费用为：turbo 策略 3元，max 策略 4元。该标准仅适用于中国内地地域。
...
支持思考模式下的`qwen3-max`、`qwen3-max-2026-01-23`；与`qwen3.5-plus`、`qwen3.5-plus-2026-02-15`、`qwen3.5-397b-a17b`。
